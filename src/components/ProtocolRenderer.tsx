...
// Props compatible with CopilotKit args (all optional during streaming)
...
function SepsisRenderer(p: RuntimeProtocolProps) {
  ...
  return (
    <div className="rounded-2xl border-2 border-red-500 bg-white shadow-xl overflow-hidden w-full max-w-sm">
      {/* Header */}
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg bg-gray-50 border border-gray-200 px-3 py-2">
          ...
          <div className="text-right">
            ...
            <p className="text-xs font-mono text-gray-600">P-001</p>
          </div>
        </div>
        ...
        {/* Allergy mutation — the key UX moment */}
        ...
        >
          ...
          <p className="text-xs text-gray-400 mt-1">Administer within 1 hour of diagnosis</p>
        </div>
        ...
        {isShock && (
          <div className="rounded-xl border-2 border-orange-400 bg-orange-50 p-3">
            ...
            <p className="text-xs text-orange-500 mt-1">Initiate if MAP &lt;65 after 30 mL/kg bolus</p>
          </div>
        )}
...
function StrokeRenderer(p: RuntimeProtocolProps) {
  ...
  return (
    <div className="rounded-2xl border-2 border-purple-500 bg-white shadow-xl overflow-hidden w-full max-w-sm">
...
function PediatricRenderer(p: RuntimeProtocolProps) {
  ...
  const headerBg = isHighRisk ? "bg-red-600" : "bg-yellow-500";

  return (
    <div className={`rounded-2xl border-2 ${borderColor} bg-white shadow-xl overflow-hidden w-full max-w-sm`}>
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Vital label="SpO₂" value={`${p.oxygenSat ?? "—"}%`} alert={(p.oxygenSat ?? 100) < 95} />
          <Vital label="RR" value={p.bloodPressure ? p.bloodPressure : "—"} alert={false} />
        </div>
